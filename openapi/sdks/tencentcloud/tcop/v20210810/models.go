...
type AgencyCourseInfo struct {
	...
	// 机构封面url,没有http开头
	// 注意：此字段可能返回 null，表示取不到有效值。
	AgencyCoverUrl *string `json:"AgencyCoverUrl,omitempty" name:"AgencyCoverUrl"`

	// 机构域名
	// 注意：此字段可能返回 null，表示取不到有效值。
	AgencyDomain *string `json:"AgencyDomain,omitempty" name:"AgencyDomain"`
	...
	// 课程封面
	// 注意：此字段可能返回 null，表示取不到有效值。
	CourseCoverUrl *string `json:"CourseCoverUrl,omitempty" name:"CourseCoverUrl"`

	// 时间
	// 注意：此字段可能返回 null，表示取不到有效值。
	CourseBeginTime *uint64 `json:"CourseBeginTime,omitempty" name:"CourseBeginTime"`

	// 课程结束时间
	// 注意：此字段可能返回 null，表示取不到有效值。
	CourseEndTime *uint64 `json:"CourseEndTime,omitempty" name:"CourseEndTime"`

	// 课程IOS平台价格
	// 注意：此字段可能返回 null，表示取不到有效值。
	CourseIosPrice *uint64 `json:"CourseIosPrice,omitempty" name:"CourseIosPrice"`

	// 课程价格
	// 注意：此字段可能返回 null，表示取不到有效值。
	CoursePrice *uint64 `json:"CoursePrice,omitempty" name:"CoursePrice"`

	// 类型 0:课程 1:课程包
	// 注意：此字段可能返回 null，表示取不到有效值。
	CourseType *uint64 `json:"CourseType,omitempty" name:"CourseType"`
...
type ChannelUserOrderDetail struct {
	...
	// 优惠券价格
	// 注意：此字段可能返回 null，表示取不到有效值。
	CouPrice *int64 `json:"CouPrice,omitempty" name:"CouPrice"`
	...
	// 红包支付金额
	// 注意：此字段可能返回 null，表示取不到有效值。
	Credit *int64 `json:"Credit,omitempty" name:"Credit"`
	...
	// 取消原因
	// 注意：此字段可能返回 null，表示取不到有效值。
	CancelReason *string `json:"CancelReason,omitempty" name:"CancelReason"`
	...
	// ios标志
	// 注意：此字段可能返回 null，表示取不到有效值。
	Ios *int64 `json:"Ios,omitempty" name:"Ios"`

	// 课程付款类型 1,免费 2，付费
	// 注意：此字段可能返回 null，表示取不到有效值。
	CoursePayId *int64 `json:"CoursePayId,omitempty" name:"CoursePayId"`
	...
	// 退款时间
	// 注意：此字段可能返回 null，表示取不到有效值。
	PayBackTime *int64 `json:"PayBackTime,omitempty" name:"PayBackTime"`

	// 课程封面url
	// 注意：此字段可能返回 null，表示取不到有效值。
	CoursePicUrl *string `json:"CoursePicUrl,omitempty" name:"CoursePicUrl"`
...
type DeleteChannelUserOrderRequest struct {
	*tchttp.BaseRequest
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DeleteChannelUserOrderRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "TermId")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DeleteChannelUserOrderRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

type DeleteChannelUserOrderResponse struct {
	*tchttp.BaseResponse
	Response *struct {
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DeleteChannelUserOrderResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type DescribeChannelUserOrderInfoRequest struct {
	*tchttp.BaseRequest

	// 千帆租户ID
	IdaasOrgId *string `json:"IdaasOrgId,omitempty" name:"IdaasOrgId"`

	// 三方平台id这里默认新闻渠道下新闻用户id 用ThirdUid来限制仅查询渠道下订单
	ThirdUid *string `json:"ThirdUid,omitempty" name:"ThirdUid"`
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeChannelUserOrderInfoRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
...
type DescribeChannelUserOrderInfoResponse struct {
	*tchttp.BaseResponse
	Response *struct {
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeChannelUserOrderInfoResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}

type DescribeChannelUserOrdersRequest struct {
	*tchttp.BaseRequest
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeChannelUserOrdersRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
...
type DescribeChannelUserOrdersResponse struct {
	*tchttp.BaseResponse
	Response *struct {
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeChannelUserOrdersResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type DescribeUserFavsRequest struct {
	*tchttp.BaseRequest
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeUserFavsRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "PageSize")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DescribeUserFavsRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

type DescribeUserFavsResponse struct {
	*tchttp.BaseResponse
	Response *struct {
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeUserFavsResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *ModifyUserFavRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
...
type ModifyUserFavResponse struct {
	*tchttp.BaseResponse
	Response *struct {
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *ModifyUserFavResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
