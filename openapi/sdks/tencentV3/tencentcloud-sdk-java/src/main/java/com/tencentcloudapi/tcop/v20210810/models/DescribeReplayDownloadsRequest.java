...
public class DescribeReplayDownloadsRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeReplayDownloadsRequest() {
    }
     ...
     */
    public DescribeReplayDownloadsRequest(DescribeReplayDownloadsRequest source) {
        if (source.VId != null) {
