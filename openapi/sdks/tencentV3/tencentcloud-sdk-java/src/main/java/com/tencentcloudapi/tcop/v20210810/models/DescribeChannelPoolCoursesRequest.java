...
public class DescribeChannelPoolCoursesRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get 课程id列表，目前仅支持单个 
     * @return CourseIds 课程id列表，目前仅支持单个
     */
    ...
    public DescribeChannelPoolCoursesRequest() {
    }
     ...
     */
    public DescribeChannelPoolCoursesRequest(DescribeChannelPoolCoursesRequest source) {
