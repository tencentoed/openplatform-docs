...
public class DescribeAgencyCouponsResponse extends AbstractModel{
    ...
    */
     ...
     */
    public void setCouponList(CouponInfo [] CouponList) {
    ...
    public DescribeAgencyCouponsResponse() {
    }
     ...
     */
    public DescribeAgencyCouponsResponse(DescribeAgencyCouponsResponse source) {
        if (source.PageNext != null) {
            this.PageNext = new Long(source.PageNext);
        }
        if (source.CouponList != null) {
            this.CouponList = new CouponInfo[source.CouponList.length];
            for (int i = 0; i < source.CouponList.length; i++) {
                this.CouponList[i] = new CouponInfo(source.CouponList[i]);
            }
        }
