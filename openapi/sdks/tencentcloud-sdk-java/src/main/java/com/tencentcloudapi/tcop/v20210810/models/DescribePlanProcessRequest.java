...
public class DescribePlanProcessRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Set 班级ID（可选）
     * @param TermId 班级ID（可选）
     */
    public void setTermId(Long TermId) {
        this.TermId = TermId;
    }

    public DescribePlanProcessRequest() {
    }
     ...
     */
    public DescribePlanProcessRequest(DescribePlanProcessRequest source) {
