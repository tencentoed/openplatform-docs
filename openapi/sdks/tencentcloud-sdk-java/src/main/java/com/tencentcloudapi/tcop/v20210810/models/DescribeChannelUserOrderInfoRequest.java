...
public class DescribeChannelUserOrderInfoRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get 三方平台id这里默认新闻渠道下新闻用户id 用ThirdUid来限制仅查询渠道下订单 
     * @return ThirdUid 三方平台id这里默认新闻渠道下新闻用户id 用ThirdUid来限制仅查询渠道下订单
     */
    ...
    /**
     * Set 三方平台id这里默认新闻渠道下新闻用户id 用ThirdUid来限制仅查询渠道下订单
     * @param ThirdUid 三方平台id这里默认新闻渠道下新闻用户id 用ThirdUid来限制仅查询渠道下订单
     */
    ...
    public DescribeChannelUserOrderInfoRequest() {
    }
     ...
     */
    public DescribeChannelUserOrderInfoRequest(DescribeChannelUserOrderInfoRequest source) {
