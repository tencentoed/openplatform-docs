...
public class DescribeLiveCoursesResponse extends AbstractModel{
    ...
    */
     ...
     */
    public CourseItem [] getCourseList() {
     ...
     */
    public void setCourseList(CourseItem [] CourseList) {
    ...
    public DescribeLiveCoursesResponse() {
    }
     ...
     */
    public DescribeLiveCoursesResponse(DescribeLiveCoursesResponse source) {
        if (source.CourseList != null) {
            this.CourseList = new CourseItem[source.CourseList.length];
            for (int i = 0; i < source.CourseList.length; i++) {
                this.CourseList[i] = new CourseItem(source.CourseList[i]);
            }
        }
