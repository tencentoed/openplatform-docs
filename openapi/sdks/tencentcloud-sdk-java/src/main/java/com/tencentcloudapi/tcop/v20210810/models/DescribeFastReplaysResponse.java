...
public class DescribeFastReplaysResponse extends AbstractModel{
    ...
    */
     ...
     */
    public void setReplayList(Replay [] ReplayList) {
    ...
    public DescribeFastReplaysResponse() {
    }
     ...
     */
    public DescribeFastReplaysResponse(DescribeFastReplaysResponse source) {
        if (source.PageNext != null) {
            this.PageNext = new Long(source.PageNext);
        }
        if (source.ReplayList != null) {
            this.ReplayList = new Replay[source.ReplayList.length];
            for (int i = 0; i < source.ReplayList.length; i++) {
                this.ReplayList[i] = new Replay(source.ReplayList[i]);
            }
        }
