...
public class CourseTerm extends AbstractModel{
    ...
    */
    ...
    @Expose
    private SubCourse [] SubCourseList;
     ...
     */
    public SubCourse [] getSubCourseList() {
     ...
     */
    public void setSubCourseList(SubCourse [] SubCourseList) {
     ...
     */
    public CourseTerm(CourseTerm source) {
        ...
        if (source.SubCourseList != null) {
            this.SubCourseList = new SubCourse[source.SubCourseList.length];
            for (int i = 0; i < source.SubCourseList.length; i++) {
                this.SubCourseList[i] = new SubCourse(source.SubCourseList[i]);
            }
        }
    }
