...
public class DescribeLiveCourseResponse extends AbstractModel{
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public DescribeLiveCourseResponse() {
    }
     ...
     */
    public DescribeLiveCourseResponse(DescribeLiveCourseResponse source) {
